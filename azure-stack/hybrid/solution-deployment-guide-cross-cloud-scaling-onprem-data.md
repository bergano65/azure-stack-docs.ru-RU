...
- Пакет средств разработки Azure Stack (ASDK) или подписка на интегрированную систему Azure Stack Hub. Чтобы развернуть Пакет средств разработки Azure Stack, следуйте инструкциям в статье [Установка Пакета средств разработки Azure Stack (ASDK)](../asdk/asdk-install.md).
...
> [!Note]  
> В интегрированной системе Azure Stack Hub общедоступный IP-адрес не должен маршрутизироваться через Интернет. В Пакете средств разработки Azure Stack (ASDK) общедоступный IP-адрес не маршрутизируется за пределы ASDK.
