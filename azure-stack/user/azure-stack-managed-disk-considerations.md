---
title: 'Управляемые диски Azure Stack: отличия и рекомендации | Документация Майкрософт'
...
> [!NOTE]  
> Управляемые диски в Azure Stack доступны, начиная с обновления 1808. Начиная с обновления 1811, эта функция включена по умолчанию при создании виртуальных машин с помощью портала Azure Stack.
...
> [!NOTE]  
> Командлет Azure PowerShell**ConvertTo-AzureRmVMManagedDisk** не может быть использован для конвертации неуправляемого диска в управляемый диск в Azure Stack. Azure Stack сейчас не поддерживает этот командлет.
