---
title: Управляемые диски Azure Stack Hub. Различия и рекомендации
...
- Узнайте о [виртуальных машинах Azure Stack Hub](azure-stack-compute-overview.md).
