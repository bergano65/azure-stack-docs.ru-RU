...
-   Установленный и работоспособный экземпляр Azure Stack (дополнительные сведения можно найти здесь: [Общие сведения о хранилище Azure Stack](azure-stack-storage-overview.md)
