---
title: Использование пользовательского портала Azure Stack | Документация Майкрософт
...
ms.locfileid: "70064171"
---
# <a name="use-the-azure-stack-user-portal"></a>Использование пользовательского портала Azure Stack
