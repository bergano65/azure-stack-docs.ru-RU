...
ms.locfileid: "75883428"
---
# <a name="how-to-establish-a-vnet-to-vnet-connection-in-azure-stack-hub-with-fortinet-fortigate-nva"></a>Установка подключения между виртуальными сетями в Azure Stack Hub с помощью NVA Fortinet FortiGate
