---
title: Начало работы со средствами разработки хранилища Azure Stack Hub | Документация Майкрософт
description: Руководство по началу работы со средствами разработки хранилища Azure Stack Hub
...
ms.locfileid: "76535932"
---
# <a name="get-started-with-azure-stack-hub-storage-development-tools"></a>Начало работы со средствами разработки хранилища Azure Stack Hub
...
> [!NOTE]  
> Существуют различия между хранилищем Azure Stack Hub и службой хранилища Azure, включая некоторые особые требования для каждой платформы. Например, для Azure Stack Hub существуют определенные клиентские библиотеки и требования к суффиксу конечной точки. Дополнительные сведения см. в статье [Объем хранилища для Azure Stack Hub. Отличия и рекомендации](azure-stack-acs-differences.md).
...
Конечная точка Azure Stack Hub содержит две части: имя региона и домен Azure Stack Hub.
...
Следующие учебники по хранилищу BLOB-объектов Azure применимы к Azure Stack Hub. Обратите внимание на конкретное требование к суффиксу конечной точки для Azure Stack Hub, описанное в предыдущем разделе [Примеры](#examples).
...
Следующие учебники по хранилищу очередей Azure применимы к Azure Stack Hub. Обратите внимание на конкретное требование к суффиксу конечной точки для Azure Stack Hub, описанное в предыдущем разделе [Примеры](#examples).
...
Следующие учебники по хранилищу таблиц Azure применимы к Azure Stack Hub. Обратите внимание на конкретное требование к суффиксу конечной точки для Azure Stack Hub, описанное в предыдущем разделе [Примеры](#examples).
