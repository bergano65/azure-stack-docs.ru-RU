...
> [!NOTE]  
> Существуют различия между хранилищем Azure Stack и службой хранилища Azure, включая некоторые особые требования для каждой платформы. Например, для Azure Stack существуют определенные клиентские библиотеки и требования к суффиксу конечной точки. Дополнительные сведения см. на странице [цен на службу хранилища Azure, раздел "Отличия и рекомендации"](azure-stack-acs-differences.md).
