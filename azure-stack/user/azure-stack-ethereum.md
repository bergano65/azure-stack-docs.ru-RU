---
title: Развертывание блокчейн-сети Ethereum в Azure Stack Hub | Документация Майкрософт
...
6. Выберите **Изменить параметры** и завершите настройку параметров шаблона для развертывания.
    ...
    Имя параметра | Description | Допустимые значения | Образец значения
    ---------------|-------------|----------------|-------------
