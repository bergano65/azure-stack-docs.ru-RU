...
> [!IMPORTANT]  
> Сейчас Azure Stack поддерживает только VPN на основе маршрутов. Если устройство поддерживает только VPN на основе политики, подключения к этим устройствам из Azure Stack не поддерживаются.  
>
> Кроме того, сейчас в Azure Stack не используются селекторы трафика на основе политик для шлюзов на основе маршрутов, так как не поддерживаются пользовательские конфигурации политики IPSec/IKE.
