...
1. Профиль версии **V2019_03_01_Hybrid**, созданный для Azure Stack. Используйте этот профиль для всех последних версий служб, доступных в Azure Stack с меткой 1904 или более поздней версии.
1. **V2017_03_09**  
