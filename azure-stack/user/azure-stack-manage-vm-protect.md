---
title: Защита виртуальных машин, развернутых в Azure Stack Hub | Документация Майкрософт
...
|  | Глобальная среда Azure | Инфраструктура Azure Stack Hub, развернутая в центре обработки данных поставщика облачных решений под управлением этого поставщика | Инфраструктура Azure Stack Hub, развернутая в центре обработки данных клиента и управляемая клиентом |
|------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------|
| **Инфраструктура Azure Stack Hub, развернутая в центре обработки данных поставщика облачных решений под управлением этого поставщика** | Пользовательские виртуальные машины развертываются в инфраструктуре Azure Stack Hub, управляемой поставщиком облачных решений.<br><br>Пользовательские виртуальные машины восстанавливаются из файла резервной копии, или для них выполняется отработка отказа напрямую в Azure. | CSP управляет основным и дополнительным экземплярами Azure Stack Hub в собственных центрах обработки данных.<br><br>Восстановление и (или) отработка отказа для пользовательских виртуальных машин выполняется между двумя экземплярами Azure Stack Hub. | CSP управляет Azure Stack Hub в основном расположении.<br><br>Центр обработки данных клиента является целью восстановления или отработки отказа. |
| **Инфраструктура Azure Stack Hub, развернутая в центре обработки данных клиента и управляемая клиентом** | Пользовательские виртуальные машины развертываются в инфраструктуре Azure Stack Hub, которой управляет клиент.<br><br>Пользовательские виртуальные машины восстанавливаются из файла резервной копии, или для них выполняется отработка отказа напрямую в Azure. | Клиент управляет Azure Stack Hub в основном расположении.<br><br>Центр обработки данных CSP является целью восстановления или отработки отказа. | Клиент управляет основным и дополнительным экземплярами Azure Stack Hub в собственных центрах обработки данных.<br><br>Восстановление и (или) отработка отказа для пользовательских виртуальных машин выполняется между двумя экземплярами Azure Stack Hub. |
...
Имейте в виду, что все облака Azure Stack Hub независимы друг от друга, поэтому они всегда являются активными с точки зрения инфраструктуры. В этом случае множество активных экземпляров приложения развертываются в одно или несколько активных облаков.
