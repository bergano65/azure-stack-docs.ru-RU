...
ms.locfileid: "67492466"
---
# <a name="tutorial-create-a-geo-distributed-app-solution-to-direct-traffic-with-azure-and-azure-stack"></a>Руководство по Создание географически распределенного приложения для перенаправления трафика в Azure и Azure Stack
...
5. Задайте **имя среды** и выберите **подписку Azure** для конечной точки облака Azure.
      ...
      ![Выберите подписку Azure для конечной точки облака Azure.](media/azure-stack-solution-geo-distributed/image9.png)
...
19. Выберите значок триггера **непрерывного** развертывания в обоих артефактах и включите триггер **непрерывного** развертывания.
    ...
    ![Выбор триггера непрерывного развертывания](media/azure-stack-solution-geo-distributed/image25.png)
