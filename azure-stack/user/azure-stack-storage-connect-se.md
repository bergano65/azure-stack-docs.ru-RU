...
Экспорт и импортируйте сертификат безопасности Azure Stack в ASDK. Для интегрированных систем сертификат подписывается публично, и этот шаг не является обязательным.
