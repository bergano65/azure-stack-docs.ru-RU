---
title: Как выполнить развертывание F5 на двух экземплярах Azure Stack Hub
...
3. Настройте широкий список IP-адресов для BIG-IP, чтобы прослушивать оба устройства, развернутых в экземплярах Azure Stack Hub A и B, согласно [описанию конфигурации BIG-IP GTM](https://techdocs.f5.com/kb/en-us/products/big-ip_gtm/manuals/product/gtm-concepts-11-5-0/4.html).
...
По завершении установки вам нужно настроить в Azure Stack Hub группы безопасности сети и заблокировать исходящие IP-адреса.
