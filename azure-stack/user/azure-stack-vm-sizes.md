---
title: Поддерживаемые размеры виртуальных машин в Azure Stack Hub
description: Справочник поддерживаемых размеров виртуальных машин в Azure Stack Hub.
author: mattbriggs
ms.topic: reference
ms.date: 03/23/2020
ms.author: mabrigg
...
ms.locfileid: "80152196"
---
# <a name="vm-sizes-supported-in-azure-stack-hub"></a>Поддерживаемые размеры виртуальных машин в Azure Stack Hub

В этой статье перечислены размеры виртуальных машин, доступных в Azure Stack Hub. С помощью этой статьи вы сможете выбрать виртуальную машину для поддержки решения Azure Stack Hub.
...
Виртуальный ЦП виртуальной машины зависит от количества ядер на узел. Например, системы с количеством физических или логических ядер менее 64 не будут поддерживать размер виртуальной машины Standard_F64s_v2.
...
> [!NOTE]
> Прекращена поддержка размеров виртуальных машин *ценовой категории "Базовый А"* для [создания Масштабируемых наборов виртуальных машин](../operator/azure-stack-compute-add-scalesets.md) на портале. Чтобы создать масштабируемый набор виртуальных машин этого размера, используйте PowerShell или шаблон.
...
|-----------------|-----|---------|---------|-----|------|-----------|----|
|**A0\Basic_A0**  |1    |768 МБ   | 20 ГБ   |300  | 300  |1/1 x 300  |2   |
|**A1\Basic_A1**  |1    |1,75 ГБ  | 40 ГБ   |300  | 300  |2/2 x 300  |2   |
|**A2\Basic_A2**  |2    |3,5 ГБ   | 60 ГБ   |300  | 300  |4 / 4 x 300  |2   |
|**A3\Basic_A3**  |4    |7 ГБ     | 120 ГБ  |300  | 300  |8/8 x 300  |2   |
|**A4\Basic_A4**  |8    |14 ГБ    | 240 ГБ  |300  | 300  |16 / 16X300 |2   |
...
*Требуется Azure Stack Hub версии 1804 или выше*
...
|Размер     |vCPU     |Память, ГиБ | Временное хранилище, Гиб  | Максимальная пропускная способность дисков ОС, операций ввода-вывода в секунду | Максимальная пропускная способность временного хранилища, операций ввода-вывода в секунду | Максимальное число дисков данных/пропускная способность: операций ввода-вывода в секунду | Максимальное число сетевых адаптеров |
|-----------------|----|----|-----|-----|------|-------------|---------|
|**Standard_DS1** |1   |3,5 |7    |1000 |4000  |4/4 x 2300   |2 |
...
|**Standard_F4s_v2**  |4   |8   |32   |1000 |8000   |8/8 x 2300    |2 |
|**Standard_F8s_v2**  |8   |16  |64   |1000 |16000  |16/16 x 2300  |4 |
|**Standard_F16s_v2** |16  |32  |128  |1000 |32000  |32/32 x 2300  |4 |
...
В размерах виртуальных машин, оптимизированных для операций в памяти, предоставляется высокое соотношение ресурсов памяти к ресурсам ЦП, что отлично подходит для серверов реляционных баз данных, кэша среднего и большого объема, а также выполняющейся в памяти аналитики.

### <a name="d-series"></a><a name="mo-d"></a>Серия D
|Размер     |vCPU     |Память, ГиБ | Временное хранилище, Гиб  | Максимальная пропускная способность дисков ОС, операций ввода-вывода в секунду | Максимальная пропускная способность временного хранилища, операций ввода-вывода в секунду | Максимальное число дисков данных/пропускная способность: операций ввода-вывода в секунду | Максимальное число сетевых адаптеров |
|------------------|---|----|----|--------|------|------------|---------|
...
### <a name="ds-series"></a><a name="mo-ds"></a>Серия DS
|Размер     |vCPU     |Память, ГиБ | Временное хранилище, Гиб  | Максимальная пропускная способность дисков ОС, операций ввода-вывода в секунду | Максимальная пропускная способность временного хранилища, операций ввода-вывода в секунду | Максимальное число дисков данных/пропускная способность: операций ввода-вывода в секунду | Максимальное число сетевых адаптеров |
|-------------------|---|----|----|--------|------|-------------|---------|
...
### <a name="dv2-series"></a><a name="mo-dv2"></a>Серия Dv2
|Размер     |vCPU     |Память, ГиБ | Временное хранилище, Гиб  | Максимальная пропускная способность дисков ОС, операций ввода-вывода в секунду | Максимальная пропускная способность временного хранилища, операций ввода-вывода в секунду | Максимальное число дисков данных/пропускная способность: операций ввода-вывода в секунду | Максимальное число сетевых адаптеров |
|--------------------|----|----|-----|----|-------|-------------|---------|
...
### <a name="dsv2-series"></a><a name="mo-dsv2"></a>Серия DSv2
|Размер     |vCPU     |Память, ГиБ | Временное хранилище, Гиб  | Максимальная пропускная способность дисков ОС, операций ввода-вывода в секунду | Максимальная пропускная способность временного хранилища, операций ввода-вывода в секунду | Максимальное число дисков данных/пропускная способность: операций ввода-вывода в секунду | Максимальное число сетевых адаптеров |
|---------------------|----|----|-----|-----|-------|--------------|---------|
...
[Возможности виртуальных машин Azure Stack Hub](azure-stack-vm-considerations.md)
