...
|AzureStack\AzureStackAdmin|Администратор узла ASDK<br><br>Можно использовать для входа на портал администрирования Azure Stack.<br><br>Войдите, чтобы просмотреть и выполнить администрирование колец Service Fabric|Администратор узла ASDK<br><br>Без доступа к порталу администрирования Azure Stack.<br><br>Войдите, чтобы просмотреть и выполнить администрирование колец Service Fabric<br><br>Больше не является владельцем подписки поставщика по умолчанию|
...
Вы можете также перейти на форумы, щелкнув **Help** (Справка) (вопросительный знак) в правом верхнем углу портала администрирования. Щелкните **Help + support** (Справка и поддержка), чтобы открыть раздел **Overview** (Общие сведения), который содержит ссылку на форум. Форумы MSDN регулярно отслеживаются.  
