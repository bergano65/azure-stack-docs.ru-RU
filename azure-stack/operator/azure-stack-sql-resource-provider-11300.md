---
title: Заметки о выпуске поставщика ресурсов SQL версии 1.1.30.0 для Azure Stack
titleSuffix: Azure Stack
description: Просмотрите заметки о выпуске для обновления поставщика ресурсов SQL версии 1.1.30.0 для Azure Stack.
