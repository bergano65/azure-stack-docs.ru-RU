...
Партнеры по интегрированной системе Azure Stack Hub предлагают множество вариантов решений, в том числе гибких возможностей хранения. Сейчас можно выбрать до двух типов дисков из трех поддерживаемых: NVMe (энергонезависимая память Express), SSD (твердотельный накопитель) SATA/SAS или HDD (жесткий диск). 

Локальные дисковые пространства включают в себя кэш, позволяющий увеличить производительность хранилища. В устройстве Azure Stack Hub с диском одного типа (например, NVM или SSD) для емкости используются все диски. При наличии дисков двух типов Локальные дисковые пространства автоматически используют все самые производительные типы дисков (NVMe &gt; SSD &gt; HDD) для кэширования. Остальные диски используются для хранения. Диски можно сгруппировать в гибридное развертывание или развертывание, полностью реализованное на базе флэш-технологии:
