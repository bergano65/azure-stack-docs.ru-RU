...
- Если вы используете комплект SDK Azure Stack Hub, предоставляется один том с несколькими общими ресурсами.
...
| Состояние работы | Description |
|---|---|
| разделение; | Диск отделен от пула.<br> <br>**Действие:** Замените диск на новый. Если вам необходимо использовать этот диск, извлеките его из системы, убедитесь, что на нем нет полезных данных, выполните очистку, а затем заново установите его. |
