---
title: Заметки о выпуске Azure Stack: обновления для системы безопасности в выпуске 1907 | Документация Майкрософт
description: Узнайте об обновлениях для системы безопасности в выпуске 1907 для Azure Stack.
