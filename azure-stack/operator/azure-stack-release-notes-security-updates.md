---
title: Заметки о выпуске Azure Stack: обновления системы безопасности в выпуске 1908 | Документация Майкрософт
description: Узнайте об обновлениях системы безопасности в выпуске 1908 для Azure Stack.
...
## <a name="1907-update"></a>Обновление 1907
...
Так как обновления Windows являются накопительными, это обновление содержит все исправления для рабочих нагрузок системы безопасности за предыдущие месяцы. В списке приведены исправления общих уязвимостей и рисков (CVE) за март, апрель и май 2019 г.
Подробные сведения об этих уязвимостях доступны по предыдущим ссылкам или в статье базы знаний Майкрософт [4499177](https://support.microsoft.com/help/4499177).
::: moniker-end

## <a name="next-steps"></a>Дополнительная информация

- [Контрольный список действий по обновлению Azure Stack](azure-stack-release-notes-checklist.md)
- [Ознакомьтесь со списком известных проблем](azure-stack-release-notes-known-issues-1908.md)
