...
| CertificateValidationError | Мост Azure не может отправить запрос, так как он не может пройти аутентификацию в службе Azure.                                    | Проверьте, не перехватывает ли прокси-сервер трафик HTTPS между виртуальной машиной XRP Azure Stack и конечной точкой шлюза использования.                                                                                                                                                                                      |
