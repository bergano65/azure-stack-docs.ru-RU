...
![Схема: интегрированная система Azure Stack](./media/azure-stack-overview/azure-stack-integrated-system.png). 
...
Azure Stack использует ту же модель операций, что и Azure. Оператор Azure Stack Hub может предоставлять пользователям клиентов разнообразные службы и приложения так же, как корпорация Майкрософт предоставляет пользователям клиентов услуги Azure. 

![Схема: роли заданий Azure Stack](./media/azure-stack-overview/azure-stack-job-roles.png)
...
[Сравнение портфеля Azure Stack](compare-azure-azure-stack.md)
