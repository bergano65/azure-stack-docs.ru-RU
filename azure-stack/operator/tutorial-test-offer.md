...
1. В области **Получить подписку** введите имя для новой подписки в поле **Отображаемое имя**. Щелкните **Предложение**, а затем выберите в списке **Выбор предложения** то предложение, которое вы создали при работе с предыдущим руководством. Нажмите кнопку **создания**.
