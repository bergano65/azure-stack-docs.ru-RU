---
title: Создание VPN-подключения типа "сеть — сеть" между двумя виртуальными сетями в разных средах ASDK | Документация Майкрософт
...
Подготовьте предложение в средах POC1 и POC2. Это позволит пользователю подписаться на него и развернуть виртуальные машины. Сведения о создании предложения см. в статье [о предоставлении виртуальных машин пользователям Azure Stack](azure-stack-tutorial-tenant-vm.md).
...
2. В следующий код PowerShell добавьте фактический пароль администратора, а затем выполните этот код на узле POC.
