...
>[!IMPORTANT]  
> Сведения этого раздела применяются при использовании Azure Stack версии 1808 или более поздней версии. Если вы используете версию 1807 или более раннюю, см. раздел [Добавление масштабируемого набора виртуальных машин (до 1808)](#add-the-virtual-machine-scale-set-prior-to-version-1808).
