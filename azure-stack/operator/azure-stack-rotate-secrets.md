...
1. Обновите контроллер управления основной платой на физических серверах Azure Stack в соответствии с инструкциями поставщика. Пароли и имена пользователя для всех контроллеров BMC в среде должны совпадать. Имена пользователей BMC должны содержать не более 16 знаков.
    ...
    > [!Note]  
    > Сначала обновите учетные данные BMC на базовом контроллере управления платой физического сервера; в противном случае команда Azure Stack завершится ошибкой во время проверки.
