---
title: Настройка мультитенантности в Azure Stack | Документация Майкрософт
description: Узнайте, как включать и отключать несколько клиентов Azure Active Directory в Azure Stack.
...
ms.locfileid: "72019376"
---
# <a name="configure-multi-tenancy-in-azure-stack"></a>Настройка мультитенантности в Azure Stack
...
После того как оператор Azure Stack разрешил использование каталога Fabrikam в Azure Stack, Мария должна зарегистрировать Azure Stack с клиентом каталога Fabrikam.
...
- [Управление потреблением и оплатой для Azure Stack в роли поставщика облачных решений](azure-stack-add-manage-billing-as-a-csp.md)
