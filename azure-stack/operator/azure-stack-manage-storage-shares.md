...
description: Узнайте, как отслеживать емкость и доступность хранилища и управлять ими в Azure Stack.
...
- См. дополнительные сведения о том, как пользователи клиента взаимодействуют с [хранилищем BLOB-объектов в Azure Stack](/azure-stack/user/azure-stack-storage-overview#azure-stack-storage-services).
...
2. Выберите **Все службы** > **Хранилище** > **Общие папки**, чтобы открыть список общих папок, в котором можно просмотреть сведения об использовании.
    ...
    ![Пример: Общие файловые ресурсы хранилища на портале администрирования Azure Stack](media/azure-stack-manage-storage-shares/storage-file-shares.png)
...
![Пример: Предупреждающее оповещение на портале администрирования Azure Stack](media/azure-stack-manage-storage-shares/alert-warning.png)
...
![Пример: Критическое оповещение на портале администрирования Azure Stack](media/azure-stack-manage-storage-shares/alert-critical.png)

**Просмотр сведений**. На портале администрирования можно открыть область сведений для просмотра параметров устранения оповещения. ![Пример. Просмотр сведений об оповещении на портале администрирования Azure Stack](media/azure-stack-manage-storage-shares/alert-details.png)
...
*Этот параметр применяется только к интегрированным системам Azure Stack.*
