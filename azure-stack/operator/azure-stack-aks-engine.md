---
title: Добавление обработчика Службы Azure Kubernetes (AKS) в Azure Stack Marketplace | Документация Майкрософт
description: Узнайте, как добавить обработчик AKS в Azure Stack Marketplace.
...
ms.locfileid: "71160260"
---
# <a name="add-the-azure-kubernetes-services-aks-engine-to-the-azure-stack-marketplace"></a>Добавление обработчика Службы Azure Kubernetes (AKS) в Azure Stack Marketplace
