...
2. Если подписки еще не назначены, выберите элемент **Получить подписку** на панели мониторинга. В колонке введите имя подписки. Затем выберите предложение. Рекомендуем развертывать кластер MySQL в его подписке, чтобы предотвратить случайное удаление.

3. Выберите **\+** **Создать ресурс** > **Вычисление**, а затем — **MySQL with Replication** (MySQL с репликацией).

   ![Развертывание пользовательского шаблона в Azure Stack Hub](media/azure-stack-tutorial-mysqlrp/img1.png)
...
4. Укажите основные сведения о развертывании на странице **Основные**. Просмотрите значения по умолчанию. При необходимости внесите изменения и нажмите кнопку **ОК**.
   ...
   - Выберите расположение (по умолчанию для ASDK оно является локальным).
     ...
     ![Основы развертывания — создание MySQL с репликацией](media/azure-stack-tutorial-mysqlrp/img2.png)
...
5. На странице **Environment Configuration** (Настройка среды) предоставьте указанные ниже сведения и щелкните **ОК**.
   ...
   - Размер диска данных в ГБ
     ...
     ![Конфигурация среды — создание MySQL с репликацией](media/azure-stack-tutorial-mysqlrp/img3.png)
...
6. Просмотрите **сводные сведения** о развертывании. При необходимости вы можете скачать настроенный шаблон и параметры, а затем щелкнуть **ОК**.
   ...
   ![Сводка — создание MySQL с репликацией](media/azure-stack-tutorial-mysqlrp/img4.png)

7. Щелкните **Создать** на странице **Купить**, чтобы начать развертывание.

   ![Страница покупки — создание MySQL с репликацией](media/azure-stack-tutorial-mysqlrp/img5.png)
...
1. На портале администратора перейдите к группе ресурсов, созданной при развертывании кластера MySQL, и выберите группу безопасности сети (**default-subnet-sg**):
   ...
   ![Выбор группы безопасности сети на портале администрирования Azure Stack Hub](media/azure-stack-tutorial-mysqlrp/img6.png)
...
2. Щелкните **Правила безопасности для входящего трафика**, а затем выберите **Добавить**.
   ...
   ![открыт](media/azure-stack-tutorial-mysqlrp/img7.png)
