...
description: Сведения о том, как включить службу "Резервное копирование инфраструктуры" с помощью портала администрирования для восстановления Azure Stack в случае сбоя.
...
- [Защита виртуальных машин, развернутых в Azure Stack](../user/azure-stack-manage-vm-protect.md)
