...
3. В окне PowerShell измените значения `RegionName`, `FQDN` и `IdentitySystem` в соответствии с используемой средой Azure Stack Hub и выполните следующий командлет:
