...
В этой статье показано, как подключить виртуальную сеть Azure Stack Hub к виртуальной сети Azure с помощью прямого подключения [Microsoft Azure ExpressRoute](/azure/expressroute/).
...
## <a name="configure-azure-stack-hub"></a>Настройка Azure Stack Hub
...
![Настройка сети для Azure Stack Hub](media/azure-stack-connect-expressroute/image2.png)
...
### <a name="ping-the-azure-stack-hub-vm"></a>Проверка подключения к виртуальной машине Azure Stack Hub
...
[Развертывание приложений в Azure и Azure Stack Hub](../user/azure-stack-solution-pipeline.md)
