...
Корпорация Майкрософт или партнер по разработке решений Azure Stack помогут оценить ваши цели. Они помогут вам ответить на следующие вопросы.
...
Используйте [планировщик ресурсов Azure Stack](https://gallery.technet.microsoft.com/Azure-Stack-Capacity-24ccd822) для изучения и анализа оптимальных аппаратных ресурсов и конфигурации в соответствии со своими требованиями. 

## <a name="ordering"></a>Размещение заказов
Ваша организация обязуется покупать Azure Stack, подписывает контракты и заказы на покупку и предоставляет поставщику решений данные о требованиях к интеграции.

## <a name="pre-deployment"></a>Перед развертыванием
Вы выбираете способ интеграции Azure Stack с вашим центром обработки данных. Корпорация Майкрософт совместно с поставщиками решений публикует [лист сведений о развертывании](azure-stack-deployment-worksheet.md), чтобы помочь вам собрать необходимые сведения.
