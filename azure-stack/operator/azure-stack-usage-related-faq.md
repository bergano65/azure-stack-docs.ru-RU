---
title: Вопросы и ответы об API использования
titleSuffix: Azure Stack Hub
description: Список часто задаваемых вопросов об использовании Azure Stack Hub, включая сведения о единицах измерения, сравнении с API использования Azure, времени использования и сообщаемом времени, а также кодах ошибок.
...
**Единица измерения**: Объем исходящих данных (в ГБ)  
**Примечания** Объем исходящего трафика службы очередей (в ГБ).
...
**Идентификатор единицы измерения**. 380874f9-300c-48e0-95a0-d2d9a21ade8f **Имя единицы измерения:** S4 **Единица измерения:** количество дисков\*месяцы **Примечания.** Управляемый диск категории "Стандартный" — 32 ГБ

**Идентификатор единицы измерения**. 1b77d90f-427b-4435-b4f1-d78adec53222 **Имя единицы измерения:** S6 **Единица измерения:** количество дисков\*месяцы **Примечания.** Управляемый диск категории "Стандартный" — 64 ГБ

**Идентификатор единицы измерения**: d5f7731b-f639-404a-89d0-e46186e22c8d **Имя единицы измерения:** S10 **Единица измерения:** количество дисков\*месяцы **Примечания.** Управляемый диск категории "Стандартный" — 128 ГБ

**Идентификатор единицы измерения**: ff85ef31-da5b-4eac-95dd-a69d6f97b18a **Имя единицы измерения:** S15 **Единица измерения:** количество дисков\*месяцы **Примечания.** Управляемый диск категории "Стандартный" — 256 ГБ

**Идентификатор единицы измерения**. 88ea9228-457a-4091-adc9-ad5194f30b6e **Имя единицы измерения:** S20 **Единица измерения:** количество дисков\*месяцы **Примечания.** Управляемый диск категории "Стандартный" — 512 ГБ

**Идентификатор единицы измерения**. 5b1db88a-8596-4002-8052-347947c26940 **Имя единицы измерения:** S30 **Единица измерения:** количество дисков\*месяцы **Примечания.** Управляемый диск категории "Стандартный" — 1024 ГБ

**Идентификатор единицы измерения**. 7660b45b-b29d-49cb-b816-59f30fbab011 **Имя единицы измерения:** P4 **Единица измерения:** количество дисков\*месяцы **Примечания.** Управляемый диск категории "Премиум" — 32 ГБ

**Идентификатор единицы измерения**. 817007fd-a077-477f-bc01-b876f27205fd **Имя единицы измерения:** P6 **Единица измерения:** количество дисков\*месяцы **Примечания.** Управляемый диск категории "Премиум" — 64 ГБ

**Идентификатор единицы измерения:** e554b6bc-96cd-4938-a5b5-0da990278519 **Имя единицы измерения:** P10 **Единица измерения:** количество дисков\*месяцы **Примечания.** Управляемый диск категории "Премиум" — 128 ГБ  

**Идентификатор единицы измерения:** cdc0f53a-62a9-4472-a06c-e99a23b02907 **Имя единицы измерения:** P15 **Единица измерения:** количество дисков\*месяцы **Примечания.** Управляемый диск категории "Премиум" — 256 ГБ

**Идентификатор единицы измерения:** b9cb2d1a-84c2-4275-aa8b-70d2145d59aa **Имя единицы измерения:** P20 **Единица измерения:** количество дисков\*месяцы **Примечания.** Управляемый диск категории "Премиум" — 512 ГБ

**Идентификатор единицы измерения**. 06bde724-9f94-43c0-84c3-d0fc54538369 **Имя единицы измерения:** P30 **Единица измерения:** количество дисков\*месяцы **Примечания.** Управляемый диск категории "Премиум" — 1024 ГБ

**Идентификатор единицы измерения**. 7ba084ec-ef9c-4d64-a179-7732c6cb5e28 **Имя единицы измерения:** ActualStandardDiskSize **Единица измерения:** ГБ\*месяц. **Примечания.** Фактический размер управляемого диска (цен. категория "Стандартный").
...
**Идентификатор единицы измерения**. 5d76e09f-4567-452a-94cc-7d1f097761f0 **Имя единицы измерения:** S4 **Единица измерения:** количество дисков\*часы **Примечания.** Управляемый диск категории "Стандартный" — 32 ГБ (не рекомендуется)

**Идентификатор единицы измерения:** dc9fc6a9-0782-432a-b8dc-978130457494 **Имя единицы измерения:** S6 **Единица измерения:** количество дисков\*часы **Примечания.** Управляемый диск категории "Стандартный" — 64 ГБ (не рекомендуется)

**Идентификатор единицы измерения:** e5572fce-9f58-49d7-840c-b168c0f01fff **Имя единицы измерения:** S10 **Единица измерения:** количество дисков\*часы **Примечания.** Управляемый диск категории "Стандартный" — 128 ГБ (не рекомендуется)

**Идентификатор единицы измерения**. 9a8caedd-1195-4cd5-80b4-a4c22f9302b8 **Имя единицы измерения:** S15 **Единица измерения:** количество дисков\*часы **Примечания.** Управляемый диск категории "Стандартный" — 256 ГБ (не рекомендуется)

**Идентификатор единицы измерения**. 5938f8da-0ecd-4c48-8d5a-c7c6c23546be **Имя единицы измерения:** S20 **Единица измерения:** количество дисков\*часы **Примечания.** Управляемый диск категории "Стандартный" — 512 ГБ (не рекомендуется)

**Идентификатор единицы измерения**. 7705a158-bd8b-4b2b-b4c2-0782343b81e6 **Имя единицы измерения:** S30 **Единица измерения:** количество дисков\*часы **Примечания.** Управляемый диск категории "Стандартный" — 1024 ГБ (не рекомендуется)

**Идентификатор единицы измерения**. 5c105f5f-cbdf-435c-b49b-3c7174856dcc **Имя единицы измерения:** P4 **Единица измерения:** количество дисков\*часы **Примечания.** Управляемый диск категории "Премиум" — 32 ГБ (не рекомендуется)

**Идентификатор единицы измерения**. 518b412b-1927-4f25-985f-4aea24e55c4f **Имя единицы измерения:** P6 **Единица измерения:** количество дисков\*часы **Примечания.** Управляемый диск категории "Премиум" — 64 ГБ (не рекомендуется)

**Идентификатор единицы измерения**. 5cfb1fed-0902-49e3-8217-9add946fd624 **Имя единицы измерения:** P10 **Единица измерения:** количество дисков\*часы **Примечания.** Управляемый диск категории "Премиум" — 128 ГБ (не рекомендуется)  

**Идентификатор единицы измерения**. 8de91c94-f740-4d9a-b665-bd5974fa08d4 **Имя единицы измерения:** P15  
**Единица измерения**: количество дисков\*часы **Примечания.** Управляемый диск категории "Премиум" — 256 ГБ (не рекомендуется)

**Идентификатор единицы измерения:** c7e7839c-293b-4761-ae4c-848eda91130b **Имя единицы измерения:** P20 **Единица измерения:** количество дисков\*часы **Примечания.** Управляемый диск категории "Премиум" — 512 ГБ (не рекомендуется)

**Идентификатор единицы измерения**. 9f502103-adf4-4488-b494-456c95d23a9f **Имя единицы измерения:** P30 **Единица измерения:** количество дисков\*часы **Примечания.** Управляемый диск категории "Премиум" — 1024 ГБ (не рекомендуется)

**Идентификатор единицы измерения**. 8a409390-1913-40ae-917b-08d0f16f3c38 **Имя единицы измерения:** ActualStandardDiskSize **Единица измерения:** байты\*часы **Примечания.** Фактический размер управляемого диска ценовой категории "Стандартный" (не рекомендуется).  

**Идентификатор единицы измерения**. 1273b16f-8458-4c34-8ce2-a515de551ef6  
**Имя единицы измерения**. ActualPremiumDiskSize **Единица измерения:** : байты\*часы **Примечания.** Фактический размер управляемого диска ценовой категории "Премиум" (не рекомендуется).

**Идентификатор единицы измерения**. 89009682-df7f-44fe-aeb1-63fba3ddbf4c  
**Имя единицы измерения**. ActualStandardSnapshotSize. **Единица измерения**: байты\*часы **Примечания.** Фактический размер управляемого моментального снимка ценовой категории "Стандартный" (не рекомендуется).

**Идентификатор единицы измерения**. 95b0c03f-8a82-4524-8961-ccfbf575f536 **Имя единицы измерения:** ActualPremiumSnapshotSize. **Единица измерения**: байты\*часы **Примечания.** Фактический размер управляемого моментального снимка диска ценовой категории "Премиум" (не рекомендуется).

**Идентификатор единицы измерения**. 75d4b707-1027-4403-9986-6ec7c05579c8. **Имя единицы измерения**: ActualStandardSnapshotSize. **Единица измерения**: ГБ\*месяц. **Примечания.** Фактический размер управляемого моментального снимка ценовой категории "Стандартный" (не рекомендуется).

**Идентификатор единицы измерения**. 5ca1cbb9-6f14-4e76-8be8-1ca91547965e. **Имя единицы измерения**: ActualPremiumSnapshotSize. **Единица измерения**: ГБ\*месяц. **Примечания.** Фактический размер управляемого моментального снимка диска ценовой категории "Премиум" (не рекомендуется).
...
**Единица измерения**: Виртуальные ядра, в часах  
**Примечания** Количество виртуальных ядер, используемых для запуска службы приложений

>[!NOTE]
>На основе этой метрики корпорация Майкрософт взимает плату за использование Службы приложений в Azure Stack Hub. Поставщики облачных решений могут определять использование ресурсов своими клиентами на основе других метрик Службы приложений (см. ниже)  
...
**Единица измерения**: 1 час **Примечания.** За час использования общего плана Службы приложений. Тарификация по планам обслуживания производится на основе каждого приложения  
  
**Идентификатор единицы измерения**. 539CDEC7-B4F5-49F6-AAC4-1F15CFF0EDA9  
**Имя единицы измерения**. Free App Service Hours  
**Единица измерения**: 1 час **Примечания.** За час использования бесплатного плана Службы приложений. Тарификация по планам обслуживания производится на основе каждого приложения  
...
**Единица измерения**: 1 час **Примечания.** Вычисляется на основе размера и количества экземпляров  
...
**Единица измерения**: часы **Примечания.** Детерминированный идентификатор метрики создается на основе SKU и пользовательского имени рабочего уровня. Этот идентификатор уникален для каждого пользовательского рабочего уровня  
...
**Имя единицы измерения**. SSL на основе IP-адреса **Единица измерения:** за привязку SSL на основе IP **Примечания.** Служба приложений поддерживает два типа SSL-подключений. SSL-подключения с указанием имени сервера (SNI) и SSL-подключения с IP-адресом. SSL-подключения на основе SNI работают только в современных браузерах, в то время как SSL-подключения на основе IP-адресов работают во всех.  
  
**Идентификатор единицы измерения**. 73215A6C-FA54-4284-B9C1-7E8EC871CC5B  
**Имя единицы измерения**.  Веб-процесс **Единица измерения:**  
...
* Сейчас в Azure Stack Hub не поддерживается [API RateCard](/azure/billing/billing-usage-rate-card-overview#azure-resource-ratecard-api-preview), который используется в Azure.
...
| 400/Bad Request |*SubscriberIdIsNotDirectTenant* |В вызове API для поставщика использовался идентификатор подписки, который указывает на недопустимый клиент вызывающего объекта. |
...
Записи об использовании включают в себя контейнер свойств с именем **additionalinfo**, который содержит идентификатор подписки Azure Stack Hub. Этот идентификатор обозначает пользовательскую подписку, создающую соответствующую запись об использовании.
