...
В рамках процесса поддержки операторы Azure Stack могут [предоставить журналы диагностики](azure-stack-configure-on-demand-diagnostic-log-collection.md#using-pep) группе поддержки и команде разработки Azure Stack, чтобы упростить устранение неполадок.
