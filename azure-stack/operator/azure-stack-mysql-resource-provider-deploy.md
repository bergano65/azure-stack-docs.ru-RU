...
> [!IMPORTANT]
> Прежде чем развертывать поставщик ресурсов MySQL версии 1.1.47.0, необходимо обновить систему Azure Stack до версии 1910 или более поздних. Версия поставщика ресурсов MySQL 1.1.47.0 для предыдущих неподдерживаемых версий Azure Stack не работает.
...
При развертывании поставщика ресурсов MySQL версии 1.1.33.0 или предыдущих необходимо установить в PowerShell определенные версии модулей AzureRm.BootStrapper и Azure Stack. Если вы развертываете поставщик ресурсов MySQL версии 1.1.47.0, этот шаг можно пропустить.
