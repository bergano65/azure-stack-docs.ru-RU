...
- Для выпуска 1910 модуль PowerShell для Azure Stack обновлен до версии 1.8.0.<br>Внесенные изменения:
