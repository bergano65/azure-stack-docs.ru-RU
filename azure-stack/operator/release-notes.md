...
- Новая версия модулей клиента Azure PowerShell в формате az.* для Azure Stack будет выпущена 16 марта 2020 г. Ныне используемые модули диспетчера ресурсов для клиента Azure Stack сохранят работоспособность, но не будут более обновляться после выпуска сборки 2002.
