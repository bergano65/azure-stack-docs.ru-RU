...
- Применимо. Эта проблема касается выпуска 1903 и более поздних версий.
- Причина. Расширение IAM устарело. Решение Ibiza, поставляемое с Azure Stack, реализует новое поведение, которое приводит к прекращению работы расширения RBAC, если пользователь открывает его из подписки, которая не выбрана в средстве выбора глобальной подписки.
- Исправление. Убедитесь, что подписка выбрана в средстве выбора глобальной подписки. 
