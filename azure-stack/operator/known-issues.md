...
- Применимо. Данная проблема касается всех поддерживаемых выпусков.
- Причина. Изменить основной сетевой адаптер виртуальной машины нельзя. Удаление или отсоединение основного сетевого адаптера приведет к проблемам с запуском виртуальной машины.
- Периодичность. Common
