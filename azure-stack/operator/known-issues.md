...
ms.locfileid: "71106511"
---
# <a name="azure-stack-known-issues"></a>Известные проблемы с Azure Stack

В этой статье перечислены известные проблемы в выпусках Azure Stack. По мере обнаружения новых неполадок список будет обновляется. **Чтобы получить доступ к известным проблемам для другой версии, используйте средство выбора версий в левом верхнем углу.**
...
Чтобы получить доступ к архивным заметкам об известных проблемах для более старой версии, используйте средство выбора версий в левом верхнем углу страницы и выберите интересующую версию. 
