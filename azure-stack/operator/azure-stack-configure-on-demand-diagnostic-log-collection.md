...
ms.locfileid: "72173068"
---
# <a name="collect-azure-stack-diagnostic-logs-on-demand"></a>Сбор журналов диагностики Azure Stack по запросу

*Область применения: интегрированные системы Azure Stack*

В процессе устранения неполадок службе поддержки пользователей Майкрософт (CSS) может потребоваться проанализировать журналы диагностики. Начиная с выпуска 1907 операторы Azure Stack могут передать журналы диагностики, собранные по запросу, в контейнер больших двоичных объектов в Azure с помощью раздела **Справка и поддержка**. Если портал недоступен, операторы могут получить журналы с помощью командлета Get-AzureStackLog через привилегированную конечную точку (PEP). В этой статье описаны оба способа сбора журналов диагностики по запросу.
