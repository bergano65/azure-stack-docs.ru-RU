...
| *OutputSeverity* | Уровень ведения журнала выходных данных. Возможные значения **Default** (По умолчанию) и **Verbose** (Подробно). Значение Default включает в себя уровни серьезности "предупреждение","критические ошибки"и "ошибка". Значение Verbose включает в себя все уровни серьезности — "подробная информация", "информация", "предупреждение", "критические ошибки" и "ошибка".  | Строка |
