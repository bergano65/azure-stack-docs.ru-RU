...
![Плитка Region Management (Управление регионами) на портале администрирования Azure Stack](media/azure-stack-monitor-health/image1.png)
...
![Плитка "Оповещения", отображающая предупреждение на портале администрирования Azure Stack](media/azure-stack-monitor-health/image3.png)
...
![Панель фильтров для фильтрации по критическому состоянию или состоянию предупреждения на портале администрирования Azure Stack](media/azure-stack-monitor-health/alert-view.png)
...
![Колонка сведений об оповещении на портале администрирования Azure Stack](media/azure-stack-monitor-health/alert-detail.png)
