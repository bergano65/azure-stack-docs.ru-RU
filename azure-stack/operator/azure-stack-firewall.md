---
title: Интеграция брандмауэра Azure Stack для интегрированных систем Azure Stack | Документация Майкрософт
description: Узнайте об интеграции брандмауэра Azure Stack для интегрированных систем Azure Stack.
...
Сейчас рекомендуется отключать любой перехват SSL (например, разгрузку расшифровки) для всего трафика Azure Stack. Если это будет реализовано в следующих обновлениях, мы предоставим инструкции по включению перехвата SSL для Azure Stack.
