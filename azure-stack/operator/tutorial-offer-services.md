...
ms.locfileid: "75727434"
---
# <a name="tutorial-offer-a-service-to-users"></a>Руководство. Предложение услуги пользователям
...
В Azure Stack есть две общие категории поставщиков ресурсов: одни развертывают ресурсы в виде основных служб, а другие — в виде дополнительных.
