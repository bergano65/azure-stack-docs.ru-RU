...
|Глобальный администратор Azure AD|Используется в процессе установки.<br><br>Владелец подписки поставщика по умолчанию.|Не применяется|
|
