...
ms.locfileid: "66691668"
---
# <a name="azure-stack-administration-basics"></a>Основы администрирования Azure Stack

Если вы не знакомы с администрированием Azure Stack, вам необходимо знать несколько моментов. В этой статье описана роль оператора Azure Stack и указано, что вам нужно сообщить пользователям для повышения продуктивности их работы.
...
Если вы хотите использовать Пакет средств разработки Azure Stack (ASDK), изучите статью [Что такое Пакет средств разработки Azure Stack?](../asdk/asdk-what-is.md), чтобы узнать больше о его назначении и ограничениях. Вы можете использовать ASDK как *песочницу* для оценки Azure Stack, а также для разработки и тестирования приложений в нерабочей среде. См. подробнее о [развертывании Пакета средств разработки Azure Stack](../asdk/asdk-install.md).

Как и Azure, мы внедряем инновации очень быстро. Мы регулярно выпускаем новые сборки. Если вы используете ASDK и хотите установить последнюю сборку, вам нужно будет [повторно развернуть Azure Stack](../asdk/asdk-redeploy.md). Вы не можете применить пакеты обновлений. Этот процесс занимает время, но преимущество заключается в том, что вы можете опробовать новые возможности. В документации по ASDK на нашем веб-сайте описана последняя сборка.
...
Кроме того, вам потребуется добавить элементы в [Marketplace](azure-stack-marketplace.md), например образы виртуальных машин. Проще всего это сделать путем [скачивания элементов marketplace из Azure в Azure Stack](azure-stack-download-azure-marketplace-item.md).
...
Кроме предоставления служб, вам необходимо выполнять все обычные обязанности оператора для поддержания работоспособности Azure Stack. В число этих обязанностей входят следующие:
...
Если проблема возникла при использовании облачных служб, поддержка предоставляется через службу поддержки корпорации Майкрософт (CSS). Щелкнув значок справки и поддержки (вопросительный знак) в правом верхнем углу портала администрирования, выберите **Справка и поддержка** и **Новый запрос на поддержку** в разделе **Поддержка**. Откройте запрос на поддержку.

Если возникла проблема с развертыванием, исправлением, обновлением, оборудованием (в том числе с модулями, заменяемыми в полевых условиях) и любым фирменным программным обеспечением (включая ПО, работающее на узле поддержки жизненного цикла оборудования), сначала обратитесь к поставщику оборудования OEM.
...
Если вы используете ASDK, вы можете задать вопросы о поддержке на [форумах Майкрософт](https://social.msdn.microsoft.com/Forums/azure/home?forum=azurestack). Щелкнув значок справки и поддержки (вопросительный знак) в правом верхнем углу портала администрирования, выберите **Справка и поддержка** и **Форумы MSDN** в разделе **Поддержка**.  Откроется сайт с форумами. Эти форумы регулярно отслеживаются. Так как ASDK предлагается как среда для оценки, официальная поддержка не предоставляется с помощью каскадных таблиц стилей от Майкрософт.
