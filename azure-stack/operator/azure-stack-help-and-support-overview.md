---
title: Справка и поддержка по Microsoft Azure Stack | Документация Майкрософт
...
ms.locfileid: "66828392"
---
# <a name="microsoft-azure-stack-help-and-support"></a>Справка и поддержка по Microsoft Azure Stack

В выпуске 1905 раздел **Справка и поддержка** на портале Azure Stack был улучшен и еще больше упрощает операторам решение их вопросов о вариантах поддержки, получение помощи специалистов и изучение возможностей Azure Stack. 

## <a name="documentation-billing-and-support"></a>Документация, выставление счетов и поддержка
...
Вопросы о поддержке Пакета средств разработки Azure Stack (ASDK) можно задать на [форуме MSDN Azure Stack](https://social.msdn.microsoft.com/Forums/azure/home?forum=azurestack). 
