---
title: Руководство. Настройка ресурсов для проверки как услуги
...
2. Добавьте в клиент участников организации. Эти пользователи будут нести ответственность за использование службы для просмотра или планирования тестов. После регистрации вы определите уровни доступа пользователей.
   ...
   4. Выберите **Пользователи и группы**. Колонка **Azure Stack Hub Validation Service - Users and group** (Служба проверки Azure Stack Hub — пользователи и группы) содержит список пользователей с разрешением на использование этого приложения.
...
2. Дождитесь подтверждения от команды проверки Azure Stack Hub, чтобы проверить, может ли клиент использовать портал VaaS.
