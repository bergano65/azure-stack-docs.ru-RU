---
title: Распространенные параметры рабочего процесса при использовании модели "проверка как услуга" в Azure Stack Hub
description: Распространенные параметры рабочего процесса при использовании модели "проверка как услуга" в Azure Stack Hub.
author: mattbriggs
ms.topic: article
ms.date: 1/22/2020
ms.author: mabrigg
...
Администратор служб             | Администратор Azure Active Directory арендатора каталога Azure AD, указанный во время развертывания Azure Stack Hub. Найдите `AADTenant` в файле конфигурации ECE и выберите значение в элементе `UniqueName`.
